...
*   Description: The one-time pad encryption server.
*******************************************************************************/
...
/*******************************************************************************
*      Function: main()
*   Description: The main otp encryption server function.
...
int main(int argc, char **argv) {
    ...
    /* Execute the server in encipher mode */
    return otp_server(argv[1], OTP_ENCIPHER);
}
